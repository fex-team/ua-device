...
//             var clink = 'https://github.com/fex-team/userAgent/issues/' + issueId + '#issuecomment-' + data[i].url.substring(data[i].url.lastIndexOf('/') + 1);
...
//     $.ajax('https://api.github.com/repos/fex-team/userAgent/issues/' + issueId + '/comments?per_page=100', {
//         headers: {
