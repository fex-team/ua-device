    ...
    Detected.prototype = {
        ...
        detect: function (ua) {
            ...
            if (ua.match('Android')) {
                ...
                this.device.type = 'mobile';
                if (this.os.version) {
                    if (parseFloat(this.os.version.original) >= 3) this.device.type = 'tablet';
                    if (parseFloat(this.os.version.original) >= 4 && ua.match('Mobile')) this.device.type = 'mobile';
            ...
            if (ua.match('Symbian') || ua.match('Series[ ]?60') || (ua.match('S60') && !ua.match('Android'))) {
